from ci_triage.signing import compute_signature, secret_hash, sign_request
...
# in both documents. This is ci-triage's own from-scratch reproduction
# (independent of cert-sentinel's/status-watch's copies) -- the whole point
# of this repo's reporting path is to be built purely from the spec.
